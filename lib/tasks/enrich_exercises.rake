  ...
  task new_exercises_1: :environment do
    exercises = [
      ...
      },
      {
        ...
        categories: ["Core", "Shoulders", "Functional"]
      },
      {
        name: "Warm up plank",
      ...
      },
      {
        ...
        categories: ["Back", "Core", "Functional"]
      },
      {
        ...
        categories: ["Back", "Shoulders", "Mobility"]
      },
      {
        name: "Inverted Rows",
        ...
        categories: ["Back", "Arms", "Functional"]
      },
      {
        name: "Dolphin Kicks",
      ...
      },
      {
        ...
        categories: ["Legs", "Functional", "Mobility"]
      },
      {
      ...
      },
      {
        ...
        categories: ["Core", "Belly", "Functional"]
      },
      {
        ...
        categories: ["Core", "Mobility", "Functional"]
      },
      {
        name: "Plank Up-Down",
      ...
      },
      {
        ...
        categories: ["Functional", "Arms", "Core"]
      },
      {
      ...
      },
      {
        ...
        categories: ["Push", "Shoulders", "Core"]
      },
      {
        name: "Handstand Hold",
        ...
        categories: ["Mobility", "Shoulders", "Core"]
      },
      {
        name: "Shoulder Taps",
        ...
        categories: ["Core", "Functional", "Shoulders"]
      },
      {
      ...
      },
      {
        ...
        categories: ["Back", "Shoulders", "Core"]
      },
      {
        name: "Jumping lunges",
        ...
        categories: ["Functional", "Legs", "Cardio"]
      },
      {
        name: "Broad jump",
